...
/**
 * This class is the Graph Controller which initializes 
 * random vertices and edges including their name and weight
 * representation and displays the whole as a graph
 * and controls the user input 
 * (number of vertices, edges and their weight can be manipulated here).
 * <p>
 * If the Input was successful, the shortest path will be
 * calculated via the Dijkstra class and displayed as text.
 *
 * @author MonkeySR1
 * @version 1.0
 * @since   2015-02-22
